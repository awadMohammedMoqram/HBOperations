...
{
    // الأدوار ذات الوصول العام لجميع البريد
    ...
    public static string GetArabicName(ReportType type) => type switch
    {
        ...
        ReportType.RejectionAnalysis  => "تحليل البريد المرفوضة",
    ...
    public static string GetDescription(ReportType type) => type switch
    {
        ...
        ReportType.ShariahCompliance  => "تقرير البريد المالية فقط للرقابة الشرعية",
        ...
        ReportType.AdminAffairsDaily  => "البريد بانتظار الاستلام والتسليم",
        ReportType.Personal           => "تقرير بريدك الشخصية فقط",
        _ => ""
    };
}
