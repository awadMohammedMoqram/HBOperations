        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mails_Branches_ReceiverBranchId",
                        column: x => x.ReceiverBranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Mails_Branches_SenderBranchId",
                        column: x => x.SenderBranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Mails_Departments_ReceiverDepartmentId",
                        column: x => x.ReceiverDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Mails_Departments_SenderDepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailHistories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailNotes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MailAttachments_IsArchived",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MailAttachments_UploadedAt",
                table: "MailAttachments",
                column: "UploadedAt");

            migrationBuilder.CreateIndex(
                name: "IX_MailHistories_PerformedAt",
                table: "MailHistories",
                column: "PerformedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mails_ReceiverBranchId_Status",
                table: "Mails",
                columns: new[] { "ReceiverBranchId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Mails_ReceiverDepartmentId_Status",
                table: "Mails",
                columns: new[] { "ReceiverDepartmentId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Mails_ReferenceNumber",
                table: "Mails",
                column: "ReferenceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Mails_SenderBranchId_Status",
                table: "Mails",
                columns: new[] { "SenderBranchId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Mails_SenderDepartmentId",
                table: "Mails",
                column: "SenderDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Mails_SenderUserId_Status",
                table: "Mails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mails_Status_CreatedAt",
                table: "Mails",
