        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Branches_ReceiverBranchId",
                        column: x => x.ReceiverBranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Branches_SenderBranchId",
                        column: x => x.SenderBranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Departments_ReceiverDepartmentId",
                        column: x => x.ReceiverDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Departments_SenderDepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionDocuments_UploadedAt",
                table: "TransactionDocuments",
                column: "UploadedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Priority",
                table: "Transactions",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ReceiverBranchId_Status",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderBranchId_Status",
                table: "Transactions",
                columns: new[] { "SenderBranchId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderDepartmentId",
                table: "Transactions",
                column: "SenderDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderUserId_Status",
                table: "Transactions",
